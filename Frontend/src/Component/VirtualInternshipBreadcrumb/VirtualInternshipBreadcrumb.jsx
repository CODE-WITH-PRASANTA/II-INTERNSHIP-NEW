        ...
        <div className="VirtualInternshipBreadcrumb-content-grid">
          ...
          <div className="VirtualInternshipBreadcrumb-text-col">
            ...
            <div className="VirtualInternshipBreadcrumb-tag-wrapper">
              ...
              <div className="VirtualInternshipBreadcrumb-tag">
                <FiGlobe className="VirtualInternshipBreadcrumb-tag-icon" />

                <span className="VirtualInternshipBreadcrumb-tag-text">
                  WORK FROM ANYWHERE
                </span>
              </div>
            </div>
            ...
            <h1 className="VirtualInternshipBreadcrumb-title">
              <span className="VirtualInternshipBreadcrumb-title-line">
                Virtual
              </span>
            ...
            <nav
              className="VirtualInternshipBreadcrumb-nav"
              aria-label="Breadcrumb"
            >
              <span className="VirtualInternshipBreadcrumb-nav-item">
                <span className="VirtualInternshipBreadcrumb-home-icon">
                  🏠
                </span>

                <a
                  href="/"
                  className="VirtualInternshipBreadcrumb-link"
                >
                  Home
                </a>
              </span>

              <span className="VirtualInternshipBreadcrumb-separator">
                /
              </span>
              ...
              <span className="VirtualInternshipBreadcrumb-active">
                Virtual Internships
              </span>
            </nav>
            ...
            <p className="VirtualInternshipBreadcrumb-description">
              Gain global experience from the comfort of your home. Connect
              with international teams and work on remote projects.
            </p>
          </div>
          ...
          <div className="VirtualInternshipBreadcrumb-media-col">
            ...
            <div className="VirtualInternshipBreadcrumb-frame">
              ...
              <img
                src={breadcrumbImage}
                alt="Virtual Internships Students"
