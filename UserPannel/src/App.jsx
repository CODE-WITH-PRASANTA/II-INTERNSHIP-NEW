    ...
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<Mainlayout />}>
          ...
          <Route path="browse-internships" element={<PagePlaceholder title="Browse Internships" />} />
          <Route path="applications" element={<PagePlaceholder title="My Applications" />} />
          <Route path="id-cards" element={<PagePlaceholder title="ID Cards" />} />
